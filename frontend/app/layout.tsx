            ...
            <a href="/" className="flex items-center gap-3 group">
              ...
              <div>
                <div className="font-extrabold text-slate-900 text-lg tracking-tight flex items-center gap-2">
                  MedSync <span className="text-[10px] font-bold uppercase tracking-wider bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded-full border border-indigo-200">XAI Studio</span>
                </div>
              </div>
            </a>

            <nav className="flex items-center gap-4 text-xs font-semibold text-slate-600">
              <a href="/" className="hover:text-indigo-600 transition px-3 py-1.5 rounded-lg hover:bg-slate-100">
                Patients Directory
              </a>
